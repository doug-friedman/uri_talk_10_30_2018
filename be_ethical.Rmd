...
### Google [has a fantastic online course](https://developers.google.com/machine-learning/crash-course/fairness/video-lecture) that teaches you  about a wide variety of human biases and how to recognize them in CS/DS.
...
.pull-left[
The issues you'll be asked to tackle with CS/DS aren't new ones. Spend some time learning about the field you are jumping into and where people went wrong beforehand.
...
Unintended ethical issues are still ethical ones.
]
